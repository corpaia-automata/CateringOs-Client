...
export default function DishDetailPage() {
  ...
  if (dishLoading || recipeLoading) return <PageSkeleton />;
  if (dishError || !dish) return <ErrorState onBack={() => router.push(`/app/${slug}/master`)} />;

  const safeRecipe = recipe ?? { batch_size: 1, batch_unit: 'plate', lines: [] };

  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        <DishHeader dish={dish} onEditClick={() => setEditOpen(true)} />
